...
<a href="https://raw.githubusercontent.com/FISA-Team/FISA/master/docker-compose.extended.yml" download="docker-compose.extended.yml">docker-compose.extended.yml</a> if you want the FROST-Server inside a docker-container as well.
